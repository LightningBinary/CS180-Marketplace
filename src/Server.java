...
public class Server {
    ...
    private static String dataBasePath = ""; // will be auto-detected or prompted
    private static int port = 4242;
    private static Database db;

    public static void main(String[] args) throws IOException {

        // Auto-detect the database file in the project directory
        String defaultPath = System.getProperty("user.dir") + "//Database1.accdb";
        File defaultDbFile = new File(defaultPath);
        if (defaultDbFile.exists() && !defaultDbFile.isDirectory()) {
